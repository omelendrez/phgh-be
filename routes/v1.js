...
router.post(
  ...
  ParticipantController.forgotPassword
)
...
router.post(
  '/account',
  participantPassport.authenticate('jwt', { session: false }),
...
router.post(
  '/bitcoin-account',
  participantPassport.authenticate('jwt', { session: false }),
  BitcoinAccountController.create
)
router.get(
  '/bitcoin-account/:id',
  participantPassport.authenticate('jwt', { session: false }),
  BitcoinAccountController.getAll
)
router.delete(
  '/bitcoin-account/:id',
  participantPassport.authenticate('jwt', { session: false }),
  BitcoinAccountController.remove
)
